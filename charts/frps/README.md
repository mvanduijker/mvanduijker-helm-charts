...
| `image.repository` | Image repository | `snowdreamtech/frps` |
...
| `service.port` | HTTP vhost service port | `80` |
...
| `config` | frps TOML configuration | `bindPort = 7000` / `vhostHTTPPort = 80` |
